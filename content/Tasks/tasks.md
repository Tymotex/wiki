...
- [ ] 🏆 Purpose
- [ ] ==2== Do all of Raymonds tasks.
- [ ] ==2== Cut nails
- [ ] ==2== Figure out all bus arrival times inthe morning
- [ ] ==2== Wear blue oxford and chinos.<br>Drink coffee.
- [ ] ==2== Out the door by 7:35, **latest**.
- [ ] ==2== Pack bag:<br>- Both laptops, each fully charged.<br>- Security keys (including USB-C adapter)<br>- Government ID, passport<br>- Water<br>- Notebook + pen
- [ ] ==2== Filter out all your questions. Put it all in Google docs.
- [ ] ==2== Fill in habit tracker
- [ ] ==2== Measure aquarium ph. Tweak
- [ ] ==2== Delete that video...
- [ ] ==1== **Google tasks**: bring Dell monitor to work. Bring laptop stand. Bring usbc charging cable
- [ ] ==1== Write an email to Raymond.<br>Let him know where you're at, your plans for today and the week. Ask for recommendations for what else to work on.<br>Let him know I'm open to attending any meetings the team is attending.<br>Let him know that I'm ready to introduce myself to coworkers.
- [ ] ==6== Maybe write a C++ program that extracts out all flashcards and dumps them to a few markdown files?
- [ ] ==6== Pick the most accessible computer science academic paper and read it fully today.<br><br>Shannon?<br>Garbage collection?
- [ ] ==1== Apply online for Australian citizenship.
- [ ] ==6== Null references billion dollar mistake
...
- [ ] ==6== Find a good computer science history book. Put it somewhere you'll know to read.
