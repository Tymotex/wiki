...
- [ ] ==2== **(20 mins)**  Drop COMP4128. Need to apply for program leave. Do it online?
...
- [ ] ==3== **(10 mins)**<br>Buy an underwater phone pouch.
- [ ] ==3== **(1 hour)**<br>Write notes on the bench press.
...
- [ ] ==3== **(1.5 hours)**<br>Complete week 1 of [EdX](https://learning.edx.org/course/course-v1:BerkeleyX+Fin101x+3T2019/home).<br>#project
- [ ] ==3== **(1 hour)** Upload all Notion notes to repo, and export your uni and high school notes from Google Docs as PDFs to upload as well.<br><br>Add an old notes disclaimer at the top of each notes page.<br><br>Be ruthless and only keep the most important notes. Archive the rest.
