...
- [x] Apply Eleuphrat.
- [ ] ==1== **(2 hours)** <br>Implement Konflux Figma prototype.<br>#project #konflux
- [ ] ==1== **(15 mins)**<br>Book all Cairns experiences.
- [ ] ==1== **(10 mins)**<br>Buy an underwater phone pouch.
- [ ] ==1== **(1 hour)**<br>Write notes on the bench press.
- [ ] ==1== **(40 mins)** Go through **Rich Dad Poor Dad** and finalise notes.
- [ ] **(40 mins)** Go through **Deep Work** and finalise notes.
- [ ] ==1== **(2 hours)** Read more about law, filling in your definitions. Specifically learn more about tax law.<br><br>Consider making a project out of this.
- [ ] ==1== **(1.5 hours)**<br>Complete week 1 of [EdX](https://learning.edx.org/course/course-v1:BerkeleyX+Fin101x+3T2019/home).<br>#project
- [ ] ==1== **(1 hour)** Upload all Notion notes to repo, and export your uni and high school notes from Google Docs as PDFs to upload as well.<br><br>Add an old notes disclaimer at the top of each notes page.<br><br>Be ruthless and only keep the most important notes. Archive the rest.
- [ ] ==1== **(40 mins)**<br>Read Spark<br>#reading #recurring
- [ ] ==1== **(40 mins)**<br>Read Spark<br>#reading #recurring
- [ ] ==1== **(40 mins)**<br>Read Spark<br>#reading #recurring
- [ ] ==1== Drop COMP4128
