...
- [ ] ==3==
**(2 hours)**<br>Investopedia stock market deep-dive:<br>- How does buying stocks through an app work?<br>- How is ownership of stocks protected?<br><br>Keep reading PassiveInvestingAustralia.com.<br>#investing  #recurring
- [ ] ==4==
Try Webull or another brokerage app.
- [ ] ==3==
<br><br>**(30 mins)**<br>On Goodreads, put up a book review for Spark.
- [ ] ==4==
<br><br><br>**(1.5 hours)**<br>Design and implement the events page.<br><br>In index.tsx, replace the features list with events listing when globally authenticated.<br>#konflux
- [ ] ==4==
<br><br><br>**(10 mins)** Make the filter safe
- [ ] ==4==
<br><br><br>**(45 mins)**<br>Read Clean Code.<br>#reading
- [ ] ==14==
<br><br><br>**(40 mins)** Go through **Deep Work** and finalise notes.
- [ ] ==1==
**(1 hour)** Go through **The Simple Path to Wealth** and finalise notes.
- [ ] ==6==
<br><br><br>**(1 hour)**<br>Determine what the next steps would be to getting a language school started.<br>#project #mum
- [ ] ==2==
<br>Begin packing for cairns. Make checklist on that page. What else is there to do before departing? Eg. pre-arrange uber trip from cairns airport to hotel?
- [ ] ==9==
<br>**(20 mins)** <br>Meeting with dad to discuss requirements for the quiz. Show dad Khan academy quiz.<br>#project
